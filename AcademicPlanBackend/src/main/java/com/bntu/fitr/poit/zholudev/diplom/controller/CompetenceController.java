...
public class CompetenceController extends EntityController<Competence> {

    @Autowired
    public CompetenceController(@Qualifier(EntityConstants.COMPETENCE_NAME) EntityService<Competence> service) {
