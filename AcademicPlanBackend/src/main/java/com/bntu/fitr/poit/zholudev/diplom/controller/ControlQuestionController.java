...
public class ControlQuestionController extends EntityController<ControlQuestion> {

    @Autowired
    public ControlQuestionController(@Qualifier(EntityConstants.CONTROL_QUESTION_NAME) EntityService<ControlQuestion> service) {
