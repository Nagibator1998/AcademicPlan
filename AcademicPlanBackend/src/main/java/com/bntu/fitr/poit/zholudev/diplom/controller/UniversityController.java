...
public class UniversityController extends EntityController<University> {

    @Autowired
    public UniversityController(@Qualifier(EntityConstants.UNIVERSITY_NAME) EntityService<University> service) {
