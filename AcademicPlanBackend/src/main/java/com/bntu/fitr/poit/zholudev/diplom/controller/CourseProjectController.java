...
public class CourseProjectController extends EntityController<CourseProject> {

    @Autowired
    public CourseProjectController(@Qualifier(EntityConstants.COURSE_PROJECT_NAME) EntityService<CourseProject> service) {
